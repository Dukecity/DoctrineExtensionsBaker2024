...
class ORM implements AdapterInterface
{
    ...
    public function __construct(?ObjectManager $om = null)
    {
        if (null === $om) {
            @trigger_error(sprintf(
                'Not providing the entity manager to the "%s" constructor is deprecated since gedmo/doctrine-extensions 3.15 and will be required in version 4.0.',
                static::class
            ), E_USER_DEPRECATED);
    ...
    public function getObjectManager()
    {
        ...
        @trigger_error('Retrieving the entity manager from the event object is deprecated. As of 4.0, it must be injected in the constructor.', E_USER_DEPRECATED);
